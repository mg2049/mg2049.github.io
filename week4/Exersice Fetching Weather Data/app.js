// Variable declaration to store reffrences 
const userCity = document.getElementById("cityInput"); 
const weather_info = document.getElementById("weather-info"); 
const btn = document.getElementById("btn"); 

// adding an event listner to button
btn.addEventListener("click", () => {
    // getting the city name 
    const name_City = userCity.value;

    // error checking to see if the field is left blank 
    if (name_City === "") {
        alert("Please enter a city name.");
    } else {
        //  making a request using our api key 
